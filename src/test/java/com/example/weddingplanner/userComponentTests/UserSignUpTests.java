...
public class UserSignUpTests {
    ...
    void signUpWithinCompleteFields() {
        //No mail
        User user = new Customer(null,"123456","Customer","Mohamed Radwan",null);
        Assertions.assertEquals("Please Complete Empty fields",service.signUp(user));
        // No password
        user=new Customer("radwan@yahoo.com",null,"Customer","Mohamed Radwan",null);
        Assertions.assertEquals("Please Complete Empty fields",service.signUp(user));
        // No username
        user=new Customer("radwan@yahoo.com","password","Customer",null,null);
        Assertions.assertEquals("Please Complete Empty fields",service.signUp(user));
    }
    ...
    void signUpWithExistentEmail(){
        User user = new Customer("amrmomtaz@gmail.com","12345678","Customer","trojan",null);
    ...
    void notValidPassword(){
        User user = new Customer("newtestsssss@gmail.com","1415","Customer","trojan",null);
    ...
    void notValidEmail(){
        User user = new Customer("@gmail.com","12345678","Customer","trojan",null);
        Assertions.assertEquals("Not valid email-address",service.signUp(user));

        user = new Customer("@gmacccil.com","12345678","Customer","trojan",null);
        Assertions.assertEquals("Not valid email-address",service.signUp(user));

        user = new Customer("ahmed@gmacccil.cccom","12345678","Customer","trojan",null);
        Assertions.assertEquals("Not valid email-address",service.signUp(user));
    }
    ...
    void signUpSuccessfully() {
        User user = new Customer( "Mohamed@gmail.com", "12345678", "Customer", "trojan", null);
