...
PRIMARY KEY(User_ID,Service_ID,Due_Date),
CONSTRAINT Cart_User_ID_FK FOREIGN KEY (User_ID) REFERENCES users(ID) ON UPDATE CASCADE ON DELETE CASCADE,
CONSTRAINT Cart_Service_ID_FK FOREIGN KEY (Service_ID) REFERENCES services(ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
PRIMARY KEY(ID),
CONSTRAINT Orders_User_ID_FK FOREIGN KEY (User_ID) REFERENCES users(ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
Service_ID INT NOT NULL,
Due_Date DATE NOT NULL,
PRIMARY KEY(Service_ID,Due_Date),
CONSTRAINT Order_item_ID_FK FOREIGN KEY (ID) REFERENCES orders(ID) ON UPDATE CASCADE ON DELETE CASCADE,
CONSTRAINT Order_Service_ID_FK FOREIGN KEY (Service_ID) REFERENCES services(ID) ON UPDATE CASCADE ON DELETE CASCADE
);
